<table class="table table-bordered table-tree" style="width: auto; margin-bottom: 1em; margin-right: 20px; white-space: nowrap;">
  ...
  <tbody>
    @if(isset($data['F-AYRB']) && count($data['F-AYRB']))
      @php
        $loop_grouping_showed = [];
        $loop_group_count = 0;
        $dont_show_total_key = [];
      @endphp
      @foreach($data['F-AYRB'] as $key_category => $data_pnl)
      @php
      ...
      <tr class="bg-black text-white fixed" data-node-id="{{ $loop->iteration }}">
        ...
        @if(!in_array($key_category, $dont_show_total_key))
          ...
          <tr class="fixed" style="background: #eaeaea" data-node-id="{{ $loop->iteration }}.1" data-node-pid="{{ $current_iteration }}">
            <td class="text-center" colspan="0"><b>{{ $data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['GROUPING_DESC'].":" }}</b></td>
            <td class="text-center"><b>{{ isset($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['ACTUAL_CURRENT']) ? number_format($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['ACTUAL_CURRENT']) : '-' }}</b></td>
            <td class="text-center"><b>{{ isset($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['ACTUAL_CURRENT_PCTG']) ? number_format($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['ACTUAL_CURRENT_PCTG'], 2)."%" : '-' }}</b></td>

            <td class="text-center"><b>{{ isset($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['LAST_MONTH_CURRENT']) ? number_format($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['LAST_MONTH_CURRENT']) : '-' }}</b></td>
            <td class="text-center"><b>{{ isset($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['LAST_MONTH_CURRENT_PCTG']) ? number_format($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['LAST_MONTH_CURRENT_PCTG'], 2)."%" : '-' }}</b></td>

            <td class="text-center"><b>{{ isset($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['VARIANCE_CURRENT']) ? number_format($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['VARIANCE_CURRENT']) : '-' }}</b></td>
            <td class="text-center"><b>{{ isset($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['VARIANCE_CURRENT_PCTG']) ? number_format($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['VARIANCE_CURRENT_PCTG'], 2)."%" : '-' }}</b></td>

            <td class="text-center"><b>{{ isset($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['LAST_YEAR_CURRENT']) ? number_format($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['LAST_YEAR_CURRENT']) : '-' }}</b></td>
            <td class="text-center"><b>{{ isset($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['LAST_YEAR_CURRENT_PCTG']) ? number_format($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['LAST_YEAR_CURRENT_PCTG'], 2)."%" : '-' }}</b></td>

            <!-- YTD TOTAL PAYROLL -->
            <td class="text-center"><b>{{ isset($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['ACTUAL_YTD']) ? number_format($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['ACTUAL_YTD']) : '-' }}</b></td>
            <td class="text-center"><b>{{ isset($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['ACTUAL_YTD_PCTG']) ? number_format($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['ACTUAL_YTD_PCTG'], 2)."%" : '-' }}</b></td>

            <td class="text-center"><b>{{ isset($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['LAST_MONTH_YTD']) ? number_format($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['LAST_MONTH_YTD']) : '-' }}</b></td>
            <td class="text-center"><b>{{ isset($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['LAST_MONTH_YTD_PCTG']) ? number_format($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['LAST_MONTH_YTD_PCTG'], 2)."%" : '-' }}</b></td>

            <td class="text-center"><b>{{ isset($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['VARIANCE_YTD']) ? number_format($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['VARIANCE_YTD']) : '-' }}</b></td>
            <td class="text-center"><b>{{ isset($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['VARIANCE_YTD_PCTG']) ? number_format($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['VARIANCE_YTD_PCTG'], 2)."%" : '-' }}</b></td>

            <td class="text-center"><b>{{ isset($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['LAST_YEAR_YTD']) ? number_format($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['LAST_YEAR_YTD']) : '-' }}</b></td>
            <td class="text-center"><b>{{ isset($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['LAST_YEAR_YTD_PCTG']) ? number_format($data['GROUPING']['F-AYRB'][$data['SHOW_GROUP_AFTER_CAT'][$key_category]]['DATA']['LAST_YEAR_YTD_PCTG'], 2)."%" : '-' }}</b></td>
          </tr>
          @endif
        @endif
