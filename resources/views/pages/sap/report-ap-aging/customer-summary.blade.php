...
@section('title', 'SAP Account Payable Aging Report')
			...
			<div class="card">
				<div class="card-body pb-0 bg-white" id="header">
						<div class="px-0 mb-5 col-md-12 float-left">
							<h1 class="text-center">Account Payable Aging Customer Summary</h1>
							<h3 class="text-center mt-2">Input your criteria below and review data</h3>
						</div>
						<div class="col-md-12 float-left">
							<form method="GET" action="{{ route('sap.report_ap_aging_vendor') }}" id='formRequest'>
			...
			var tables =  $('#content-table').DataTable({
				...
				"buttons": {
					...
					buttons: [
					{
						...
						text: 'Export Excel',
						footer: false,
						title : 'Account Payable Aging Summary For All Types',
				...
				"processing": true,
				"ajax": {
	                url : "/sap/customer-ap-aging-summary/get-data",
	                data : {
