            ...
            <div class="card">
                <div class="card-body pb-0 bg-white" id="header">
                    <div class="px-0 mb-5 col-md-12 float-left">
                        <h1 class="text-center">Account Receivable Aging Report</h1>
                            ...
                            <tr>
                                <td>
                                    <span style="display: none;">
                                        {{ !empty($ar['POSTING_DATE']) && $ar['POSTING_DATE']!=='00000000' ? strtotime($ar['POSTING_DATE']) : 0 }}
                                    </span>
                                    {{ !empty($ar['POSTING_DATE']) && $ar['POSTING_DATE']!=='00000000' ? date('d M Y',strtotime($ar['POSTING_DATE'])) : '-' }}
                                </td>
