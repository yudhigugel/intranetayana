                            ...
                            <tr>
                                ...
                                <td class="title" style="width:33.333%">
                                    <div class="text-right">
                                        <img src="/bali/ayana_template/img/ayana-bali-logo-color.png" style="width:60px; margin: -2px;">
                                        <img src="/bali/ayana_template/img/rimba-bali-logo-color.png" style="width:60px; margin: -2px;">
                                        <img src="/bali/ayana_template/img/thevillas-bali-logo-color.png" style="width:60px; margin: -2px;">
                                    </div>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td>
                                    ...
                                    @else
                                        ...
                                        <p style="margin-top:-3px;font-size:12px;">P +62-361-8468468 | E finance@ayanaresort.com | <a target="_blank" href="https://www.ayana.com">www.ayana.com</a></p>
                                    @endif
                                </td>
                            </tr>
                        </table>
