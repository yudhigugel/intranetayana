                    ...
                    <td colspan="9">
                        <table>
                            <tr>
                                ...
                                <img src="/bali/ayana_template/img/new_logo/pnb.png" style="width:60px;float:right;margin-top:-8px">
                                </td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <table>
                            <tr>
                                <td>
                                    ...
                                    @else
                                        <p style="margin:0;font-size:20px;font-weight:bold;">PT. {{ isset($data['invoice']->BUTXT) && !empty($data['invoice']->BUTXT) ? strtoupper($data['invoice']->BUTXT) : 'PRIMA NUSA BAHARI' }}</p>
                                        <p style="margin:0;font-size:12px;">Kompleks Tragia Nusa Dua No. 35 Jl By Pass Ngurah Rai. Kab Badung, Bali 80364 – Indonesia.</p>
                                        <p style="margin-top:-3px;font-size:12px;">P +62-361-702222 | E reservation@ayanalakodia.com | <a target="_blank" href="https://ayanalakodia.com">www.ayanalakodia.com</a></p>
                                    @endif
                                </td>
                            </tr>
                        </table>
