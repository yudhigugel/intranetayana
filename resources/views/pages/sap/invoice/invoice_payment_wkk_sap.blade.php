                                ...
                                <td class="title" style="width:33.333%">
                                    @if(isset($data['invoice']->PRCTR))
                                        @if(strtoupper($data['invoice']->PRCTR) == 'WKK1')
                                            <img src="/bali/ayana_template/img/delonix-hotel.png" style="width:80px;float:right;margin:-10px 0 0 0">
                                        @elseif(strtoupper($data['invoice']->PRCTR) == 'WKK2')
                                            <img src="/bali/ayana_template/img/delonix-apartment.png" style="width:70px;float:right;margin:-10px 0 0 0">
                                        @endif
                                    @else
                                        <img src="/bali/ayana_template/img/delonix-hotel.png" style="width:70px; margin: -10px -2px -2px;">
                                        <img src="bali/ayana_template/img/delonix-apartment.png" style="width:70px; margin: -10px -2px -2px;">
                                    @endif
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td>
                                    ...
                                    @else
                                        ...
                                        <p style="margin:0;font-size:12px;">Komplek Sedana Golf Km.47 Teluk Jambe - Karawang, Jawa Barat 41361 – Indonesia.</p>
                                        <p style="margin-top:-3px;font-size:12px;">P +62-267-644370 | E info@delonixhotel.com | <a target="_blank" href="https://www.delonixhotel.com">www.delonixhotel.com</a></p>
                                    @endif
                                </td>
                            </tr>
                        </table>
