                    ...
                    <td colspan="9">
                        <table>
                            <tr>
                                ...
                                <img src="/bali/ayana_template/img/logo_ayana_residences.png" style="width:60px;float:right;margin:0">
                                </td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <table>
                            <tr>
                                <td>
                                    ...
                                    @else
                                        <p style="margin:0;font-size:20px;font-weight:bold;">PT. {{ isset($data['invoice']->BUTXT) && !empty($data['invoice']->BUTXT) ? strtoupper($data['invoice']->BUTXT) : 'NUSA JAYA PRIMA' }}</p>
                                        <p style="margin:0;font-size:12px;">Karang Mas Estate. Jl Karang Mas Sejahtera. Kab Badung, Bali 80364 – Indonesia.</p>
                                        <p style="margin-top:-3px;font-size:12px;">P +62-361-702120 | E finance@ayanaresidences.com | <a target="_blank" href="https://ayanaresidences.com">www.ayanaresidences.com</a></p>
                                    @endif 
                                </td>
                            </tr>
                        </table>
