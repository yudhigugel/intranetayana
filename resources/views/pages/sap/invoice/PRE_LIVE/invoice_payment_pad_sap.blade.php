                            ...
                            <tr>
                                ...
                                <td class="title" style="width:33.333%">
                                    <div class="text-right">
                                        <img src="/bali/ayana_template/img/new_logo/ayana-midplaza.svg" style="width:60px; margin: -10px -2px -2px;">
                                        <img src="/bali/ayana_template/img/new_logo/plaza-residences.png" style="width:60px; margin: -10px -2px -2px;">
                                    </div>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td>
                                    @if(isset($plant_info) && $plant_info)
                                        ...
                                        <p style="margin-top:-3px;font-size:12px;">P {{ isset($plant_info->PHONE) ? '+'.$plant_info->PHONE : '+62-361-8468468' }} | E {{ isset($plant_info->EMAIL) ? strtolower($plant_info->EMAIL) : '-' }} | <a target="_blank" href="{{ isset($plant_info->WEB) ? strtolower($plant_info->WEB) : '-' }}">{{ isset($plant_info->WEB) ? strtolower($plant_info->WEB) : '-' }}</a></p>
                                    @else
                                        <p style="margin:0;font-size:20px;font-weight:bold;">PT. {{ isset($data['invoice']->BUTXT) && !empty($data['invoice']->BUTXT) ? strtoupper($data['invoice']->BUTXT) : 'PRIMA ADHITAMA INTERNATIONAL DEVELOPMENT' }}</p>
                                        <p style="margin:0;font-size:12px;">Jl Jendral Sudirman Kav 10-11, Jakarta 10220 – Indonesia.</p>
                                        <p style="margin-top:-3px;font-size:12px;">P +62-21-5707555 | E care@plazaresidences.com | <a target="_blank" href="https://plazaresidences.co.id/">www.plazaresidences.co.id</a></p>
                                    @endif
                                </td>
                            </tr>
                        </table>
