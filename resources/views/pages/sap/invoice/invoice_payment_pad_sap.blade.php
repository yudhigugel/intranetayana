                                    ...
                                    <div class="text-right">
                                        @if(isset($data['invoice']->PRCTR))
                                            @if(strtoupper($data['invoice']->PRCTR) == 'PAD1')
                                                <img src="/bali/ayana_template/img/ayana-midplaza.png" style="width:80px;float:right;margin:0">
                                            @elseif(strtoupper($data['invoice']->PRCTR) == 'PAD2')
                                                <img src="/bali/ayana_template/img/plaza-residences.png" style="width:90px;float:right;margin:0">
                                            @endif
                                        @else
                                            <img src="/bali/ayana_template/img/ayana-midplaza.png" style="width:60px; margin: -10px -2px -2px;">
                                            <img src="/bali/ayana_template/img/plaza-residences.png" style="width:65px; margin: -10px -2px -2px;">
                                        @endif
                                    </div>
                                </td>
                            </tr>
