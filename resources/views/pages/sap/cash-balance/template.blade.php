    ...
    <div class="table-wrapper">
      <div class="table-container-h table-responsive" style="overflow-x: unset;">
          <table class="table table-bordered" id="content-table">
            <thead>
              <tr>
                <th style="width: 30.5%" class="text-left">Group Type Balance</th>
              ...
              <tr>
                <th class="text-left">All Bank Balance</th>
              ...
              <tr>
                <th class="text-left">All Time Deposit</th>
                    ...
                    <thead>
                      @if(isset($data['RFC']) && $data['RFC'])
                        ...
                        <tr data-node-id="{{ $loop->iteration }}">
                          ...
                          <th class="text-left bg-black text-white">{{ $company_code }}</th>
                        </tr>
