...
@section('title', 'Master Group Role - Add')
  ...
  <div class="col-12 stretch-card" style="position: relative;">
    ...
    <div class="card">
      <div class="card-body main-wrapper" style="overflow-x: auto;overflow-y: hidden;">
        ...
        <h2 class="card-title"><i class="mdi mdi-plus"></i> Create Role</h2>
        <form method="POST" action="{{ url('/access/management/master-role/create') }}" id="form-access-menu">
          {{ csrf_field() }}
          <div class="form-group">
            <div class="row mb-3">
              <div class="col-12">
                <label>Role Name</label>
                <input type="text" name="role_name" required class="form-control" placeholder="Input Role Name" value="{{ old('role_name') }}">
                @error('role_name')
          ...
          <div class="form-group">
            <div class="row mb-3" id="route-url-wrapper">
              <div class="col-12">
                ...
                <input type="text" name="description" id="description" class="form-control" placeholder="Input Brief Description" value="{{ old('description') }}">
                @error('description')
                  <small class="text-danger mb-2 mt-1 d-block">
                    <i class="mdi mdi-alert-circle"></i>&nbsp;&nbsp;{{ $message }}
                  </small>
