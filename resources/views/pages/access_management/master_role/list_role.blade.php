...
@section('title', 'Master Group Role - List')
  ...
  <div class="col-12 stretch-card" style="position: relative;">
    ...
    <div class="card"> 
        <div class="card-body main-wrapper" style="overflow-x: auto;overflow-y: hidden;">
          ...
          @if(Session::get('permission_menu')->has("create_".route('masterrole.list', array(), false)))
          <div class="form-group">
            <a href="{{ route('masterrole.add') }}" class="btn btn-primary text-white"><i class="mdi mdi-plus"></i>&nbsp;Add New Role</a>
          </div>
          @endif
          <div id="breakpoint">
             <table id="dynamic-table" class="table table-bordered" cellspacing="0" width="100%">
               <thead>
                  <tr>
                   ...
                   <th class="all" style="width: 10%">ROLE NAME</th>
                   <th class="all" style="width: 15%">DESCRIPTION</th>
                   <th class="all" style="width: 10%">ROLE STATUS</th>
...
<script type="text/javascript">
  $(document).ready( function () {
      var table = $('#dynamic-table').DataTable(
      {
        ...
        "ajax": {
          "type" : "GET",
          "url" : "/access/management/master-role/getData",
