...
@section('title', 'Master Group Role - Edit')
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
    ...
    <li aria-current="page" class="breadcrumb-item active"><span>Master Group Role</span></li></ol>
</nav>
  ...
  <div class="col-12 stretch-card" style="position: relative;">
    ...
    <div class="card">
      <div class="card-body main-wrapper" style="overflow-x: auto;overflow-y: hidden;">
        ...
        <h2 class="card-title"><i class="mdi mdi-plus"></i> Edit Role</h2>
        <form method="POST" id="form-access-menu">
          ...
          <div class="form-group">
            <div class="row mb-3">
              <div class="col-12">
                ...
                <input type="text" name="role_name" required class="form-control" placeholder="Input Role Name" value="{{ isset($data_edit->ROLE_NAME) ? $data_edit->ROLE_NAME : '' }}">
                @error('role_name')
          ...
          <div class="form-group">
            <div class="row mb-3" id="route-url-wrapper">
              <div class="col-12">
                ...
                <input type="text" name="description" id="description" class="form-control" placeholder="Input Brief Description" value="{{ isset($data_edit->DESCRIPTION) ? $data_edit->DESCRIPTION : '' }}">
                @error('description')
                  <small class="text-danger mb-2 mt-1 d-block">
                    <i class="mdi mdi-alert-circle"></i>&nbsp;&nbsp;{{ $message }}
                  </small>
          ...
          <div class="form-group">
            ...
            <div>
              <a class="btn-delete" data-url-delete="{{ route('masterrole.remove', [isset($data_edit->SEQ_ID) ? $data_edit->SEQ_ID : 0]) }}">
                <small class="text-danger" style="cursor: pointer"><i class="fa fa-trash"></i>&nbsp;&nbsp;Delete Role</small>
              </a>
            </div>
          </div>
        </form>
  ...
  $(document).ready( function () {
     ...
     $(document).on('click', '.btn-delete', function(){
        ...
        Swal.fire({
          ...
          title: 'Delete Role',
          html: "<span style='line-height:1.5'>Are you sure want to delete this Role ? <br>Role and related data will be completely removed from list<span>",
          icon: 'warning',
