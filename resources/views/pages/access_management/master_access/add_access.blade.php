...
@section('title', 'Master Access Type - Add')
  ...
  <div class="col-12 stretch-card" style="position: relative;">
    ...
    <div class="card">
      <div class="card-body main-wrapper" style="overflow-x: auto;overflow-y: hidden;">
        ...
        <h2 class="card-title"><i class="mdi mdi-plus"></i> Add Menu Access</h2>
        <form method="POST" action="{{ url('/access/management/master-access/create') }}" id="form-access-menu">
          {{ csrf_field() }}
          <div class="form-group">
            <div class="row mb-3">
              <div class="col-12">
                <label>Menu Access Name</label>
                <input type="text" name="access_name" required class="form-control" placeholder="Input Menu Access Name" value="{{ old('access_name') }}">
                @error('access_name')
