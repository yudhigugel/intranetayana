...
@section('title', 'Master Sidebar Menu - Edit')
  ...
  <div class="col-6 stretch-card" style="position: relative;">
    ...
    <div class="card">
      <div class="card-body main-wrapper" style="overflow-x: auto;overflow-y: hidden;">
        ...
        <h2 class="card-title"><i class="mdi mdi-plus"></i> Update Menu</h2>
        <form method="POST" id="form-access-menu">
          ...
          <div class="form-group">
            <div class="row mb-3">
              <div class="col-12">
                ...
                <input type="text" name="menu_name" required class="form-control" placeholder="Input Menu Name" value="{{ isset($data_edit->MENU_NAME) ? $data_edit->MENU_NAME : '' }}">
                @error('menu_name')
            ...
            <div class="row mb-3" id="route-url-wrapper">
              <div class="col-12">
                ...
                <input type="text" name="path" id="route-url" required class="form-control" placeholder="Input URL" value="{{ isset($data_edit->PATH) ? $data_edit->PATH : '' }}">
                @error('path')
                  <small class="text-danger mb-2 mt-1 d-block">
                    <i class="mdi mdi-alert-circle"></i>&nbsp;&nbsp;{{ $message }}
                  </small>
            ...
            <div class="row mb-3" id="route-name-wrapper">
              <div class="col-12">
                ...
                <input type="text" name="path_name" id="route-name" required class="form-control" placeholder="Input URL Alias" value="{{ isset($data_edit->ROUTE_NAME) ? $data_edit->ROUTE_NAME : '' }}">
                @error('path_name')
                  <small class="text-danger mb-2 mt-1 d-block">
                    <i class="mdi mdi-alert-circle"></i>&nbsp;&nbsp;{{ $message }}
                  </small>
            ...
            <div class="row mb-3">
              <div class="col-12">
                ...
                <input type="text" name="icon" class="form-control" placeholder="Input Icon Class (mdi-*)" value="{{ isset($data_edit->ICON) ? $data_edit->ICON : '' }}">
                @error('icon')
                  <small class="text-danger mb-2 mt-1 d-block">
                    <i class="mdi mdi-alert-circle"></i>&nbsp;&nbsp;{{ $message }}
                  </small>
            ...
            <div class="row mb-3">
              <div class="col-12">
                ...
                <input type="text" name="iframe_source" class="form-control" placeholder="Input Iframe URL" value="{{ isset($data_edit->IFRAME_SOURCE) ? $data_edit->IFRAME_SOURCE : '' }}">
                @error('iframe_source')
                  <small class="text-danger mb-2 mt-1 d-block">
                    <i class="mdi mdi-alert-circle"></i>&nbsp;&nbsp;{{ $message }}
                  </small>
          ...
          <div class="form-group">
            ...
            <div>
              <a class="btn-delete" data-url-delete="{{ route('mastermenu.remove', [isset($data_edit->SEQ_ID) ? $data_edit->SEQ_ID : 0]) }}">
                <small class="text-danger" style="cursor: pointer"><i class="fa fa-trash"></i>&nbsp;&nbsp;Delete Menu</small>
              </a>
            </div>
          </div>
        </form>
