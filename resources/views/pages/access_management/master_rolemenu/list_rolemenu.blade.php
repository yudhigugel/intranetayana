...
@section('title', 'Group Role (Assign Menu) - List')
  ...
  <div class="col-12 stretch-card" style="position: relative;">
    ...
    <div class="card"> 
        <div class="card-body main-wrapper" style="overflow-x: auto;overflow-y: hidden;">
          ...
          @if(Session::get('permission_menu')->has("create_".route('masterrolemenu.list', array(), false)))
          <div class="form-group">
            <a href="{{ route('masterrolemenu.add') }}" class="btn btn-primary text-white"><i class="mdi mdi-plus"></i>&nbsp;Assign Role Menu</a>
          </div>
          @endif
             ...
             <table id="dynamic-table" class="table table-bordered" cellspacing="0" width="100%">
               <thead>
                  <tr>
                   ...
                   <th class="all" style="width: 20%">ROLE NAME</th>
                   <th class="all" style="width: 10%">ASSIGNED MENU</th>
                   <th class="all" style="width: 8%">STATUS MENU</th>
...
<script type="text/javascript">
  $(document).ready( function () {
      var table = $('#dynamic-table').DataTable(
      {
        ...
        "ajax": {
          "type" : "GET",
          "url" : "/access/management/master-rolemenu/getData",
        ...
        "columns": [
           ...
           { "data": "MENU_AVAILABLE", className: 'text-right'},
    ...
    $(document).on('click', '.btn-delete', function(){
      ...
      Swal.fire({
        title: 'Assigned Menu Active / Deactive',
        html: "<span style='line-height:1.5'>Are you sure want to active / deactive all this Menu from corresponding Role ? <br>Menu will disappear for all user assigned to it<span>",
        icon: 'warning',
