                  ...
                  <div class="col-12">
                    ...
                    <div class="row text-center">
                      <div class="col-12 text-left">
                        <h4 class="form-group"><input type="checkbox" name="menu[]" value="{{ $parent['SEQ_ID'] }}" class="mr-2 checkbox-title" data-unique="{{ $parent['SEQ_ID'] }}"><b>{{ $parent['MENU_NAME'] }}</b></h4>
                            ...
                            <div class="row align-items-center justify-content-center">
                                      ...
                                      <div class="row align-items-center justify-content-center">
                                        <div class="col-4">
                                          <div class="collapse show pl-4 ml-4" id="icons-{{ $child_2['PARENT_ID'] }}">
                                            <ul class="nav flex-column sub-menu mb-2">
                                              <li><input type="checkbox" name="menu[]" value="{{ $child_2['SEQ_ID'] }}" class="mr-1 checkbox-child" data-parent-id="{{ $child_2['PARENT_ID'] }}"><h6 class="menu-title d-inline-block" style="font-weight: lighter">{{ $child_2['MENU_NAME'] }}</h6></li>
                                            </ul>
                                          </div>
                                        </div>
                                        ...
                                        <div class="collapse show col-2 text-center" id="icons-{{ $child_2['PARENT_ID'] }}">
                                          <label class="toggle-switch">
                                            <input type="checkbox" name="permission[]" value="{{ $child_2['SEQ_ID'] }}.{{ $permission->SEQ_ID }}">
                              ...
                              @elseif (isset($child_1['child']) && count($child_1['child']) < 1)
                                ...
                                <div class="col-2 text-center">
                                  <label class="toggle-switch">
                                    <input type="checkbox" name="permission[]" value="{{ $child_1['SEQ_ID'] }}.{{ $permission->SEQ_ID }}">
                                    <span class="toggle-slider round"></span>
                                  </label>
                                  <small class="ml-2">{{ $permission->PERMISSION_NAME }}</small>
                                </div>
