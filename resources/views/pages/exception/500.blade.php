          ...
          <div class="col-lg-7 mx-auto text-white">
            <div class="row align-items-center d-flex flex-row">
              <div class="col-lg-6 text-lg-right pr-lg-4">
                <h1 class="display-1 mb-0 text-white"><strong>500</strong></h1>
              </div>
              <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                <h2 class="text-white">SORRY!</h2>
                <h3 class="font-weight-light text-white">
                @if(Session::has('invalid_payload'))
                  {{ Session::get('invalid_payload') }}
                @else
                  {{ "The server went into a problem, please wait for a moment and try again." }}
                @endif
                </h3>
              </div>
            </div>
