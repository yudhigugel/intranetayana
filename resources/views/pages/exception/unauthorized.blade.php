...
@section('content')
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
      ...
      <li aria-current="page" class="breadcrumb-item active"><span>Unauthorized</span></li></ol>
  </nav>
                ...
                <div class="card-body main-wrapper" style="overflow-x: auto;overflow-y: hidden; min-height: 50vh">
                    <div class="d-flex align-items-center" style="min-height: 40vh">
                      <div class="flex-fill text-center">
                        ...
                        <div>
                          <h6 class="text-muted" style="line-height: 1.5">Opps, you are not allowed to access this page <br> Contact your IT administrator if this page should be visible on your account</h6>
                          <a href="/">Go Back</a>
                        </div>
                      </div>
                    </div>
