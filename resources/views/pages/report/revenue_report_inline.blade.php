    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="wrapper">
            <form method="POST" action="{{ route('revenue_report_inline.all') }}" id="form-comparison">
              {{ csrf_field() }}
              <div class="d-flex mb-3">
                ...
                <div class="text-left form-group flex-fill ml-2 mr-2">
                  <label class="label">Year To Compare</label>
              ...
              <div class="form-quartal mr-2 ml-2 text-left form-group">
                <label class="label">Choose Quarter</label>
                <div style="margin-top: -10px" class="mb-2">
                  <small class="text-muted">* Leave uncheck to get all Quarter</small>
                </div>
  ...
  <div class="row flex-grow" id="main-header">
        <div class="col-sm-12 stretch-card" style="position: relative;">
            ...
            <div class="card">
                <div class="card-body pb-0 bg-white" id="header">
                    ...
                    <div class="filter-container mb-3">
                        @if(isset($comparison) && $comparison)
                          <a href="{{ route('revenue_report_inline.all') }}" class="btn disabled text-white btn-primary quarter-filter quarter-filter-all">All Quarter</a>
                          <a href="{{ route('revenue_report_inline.quartal', ['quartal' => 'Q1'.$year_lookup]) }}" class="btn disabled text-white btn-primary quarter-filter quarter-filter-q1 quarter-hide">Q1</a>
                          <a href="{{ route('revenue_report_inline.quartal', ['quartal' => 'Q2'.$year_lookup]) }}" class="btn disabled text-white btn-primary quarter-filter quarter-filter-q2 quarter-hide">Q2</a>
                          <a href="{{ route('revenue_report_inline.quartal', ['quartal' => 'Q3'.$year_lookup]) }}" class="btn disabled text-white text-white btn-primary quarter-filter quarter-filter-q3">Q3</a>
                          <a href="{{ route('revenue_report_inline.quartal', ['quartal' => 'Q4'.$year_lookup]) }}" class="btn disabled text-white btn-primary quarter-filter quarter-filter-q4">Q4</a>
                        @else
                        <a onclick="$('.overlay').addClass('in')" href="{{ route('revenue_report_inline.all') }}" class="btn @if(isset($QUARTAL) && count($QUARTAL) == 4) disabled @endif text-white btn-primary quarter-filter quarter-filter-all">All Quarter</a>
                          <a onclick="$('.overlay').addClass('in')" href="{{ route('revenue_report_inline.quartal', ['quartal' => 'Q1'.$year_lookup]) }}" class="btn @if(isset($QUARTAL) && count($QUARTAL) == 1 && array_keys($QUARTAL)[0] == 'Q1') disabled @endif text-white btn-primary quarter-filter quarter-filter-q1 quarter-hide">Q1</a>
                          <a onclick="$('.overlay').addClass('in')" href="{{ route('revenue_report_inline.quartal', ['quartal' => 'Q2'.$year_lookup]) }}" class="btn @if(isset($QUARTAL) && count($QUARTAL) == 1 && array_keys($QUARTAL)[0] == 'Q2') disabled @endif text-white btn-primary quarter-filter quarter-filter-q2 quarter-hide">Q2</a>
                          <a onclick="$('.overlay').addClass('in')" href="{{ route('revenue_report_inline.quartal', ['quartal' => 'Q3'.$year_lookup]) }}" class="btn @if(isset($QUARTAL) && count($QUARTAL) == 1 && array_keys($QUARTAL)[0] == 'Q3') disabled @endif text-white text-white btn-primary quarter-filter quarter-filter-q3">Q3</a>
                          <a onclick="$('.overlay').addClass('in')" href="{{ route('revenue_report_inline.quartal', ['quartal' => 'Q4'.$year_lookup]) }}" class="btn @if(isset($QUARTAL) && count($QUARTAL) == 1 && array_keys($QUARTAL)[0] == 'Q4') disabled @endif text-white btn-primary quarter-filter quarter-filter-q4">Q4</a>
                        @endif
                        ...
                        <div class="float-right">
                            ...
                            @if(isset($comparison) && $comparison)
                              <a class="btn btn-danger text-white" href="{{ route('revenue_report_inline.all') }}"><i class="fa fa-window-close"></i></a>
                            @endif
                            </div>
                        </div>
                ...
                <div class="card-body main-wrapper" style="overflow-x: auto;overflow-y: hidden; @if($comparison) margin-right: 1.75rem; @endif">
                    @if(isset($comparison) && !$comparison)
