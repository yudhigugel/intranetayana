    ...
    <div class="form-group">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" readonly name="Delivery_Date" value="{{ isset($data['data_json']->Delivery_Date) ? date('d F Y', strtotime($data['data_json']->Delivery_Date)) : date('d F Y') }}" class="form-control datepicker3"/>
            </div>
            <div class="col-md-6">
                <label>Purpose / Notes <span class="red">*</span></label>
                <input type="text" class="form-control" value="{{ isset($data['data_json']->purpose) ? $data['data_json']->purpose : '' }}" name="purpose" readonly placeholder="insert your purpose / notes on requesting purchase requisition"/>
            </div>
        </div>
    </div>
                    ...
                    @if(isset($data['data_json']->marketlistItemOrder) && count($data['data_json']->marketlistItemOrder) > 0)
                        ...
                        @foreach($data['data_json']->marketlistItemOrder as $key => $item_list)
                            ...
                            <tr>
                                ...
                                <td class="text-left">
                                    <input type="text" {{ $editable }} class="form-control" name="marketlistMaterialNote[]" value="{{ isset($data['data_json']->marketlistMaterialNote[$key]) ? $data['data_json']->marketlistMaterialNote[$key] : '' }}">
                                </td>
    ...
    function qtyInputDetail(elem){
        ...
        if(parseFloat(elem.value) > 0){
            ...
            delayInAjaxCall(function(){
                ...
                checkLastPriceDetail(elem, material_code, material_name, material_uom);
            }, 1000);
        } else {
            try {
