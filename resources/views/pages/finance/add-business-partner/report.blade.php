...
<script type="text/javascript">
  var objFile = {};var objJsonDetail = {}; var objRow = {};
    ...
    $(document).ready( function () {
        ...
        var table = $('#requestList').DataTable({
            ...
            "buttons": {
                ...
                [{
                  ...
                  // },
                  title: '',
                  filename : 'AYANA Intranet - Business Partner Export',
                  exportOptions: {
                  ...
                  action: function(e, dt, button, config) {
                    ...
                    if(data_revenue.length > 0) {
                      ...
                      $.ajax({
                        "url": "/finance/add-business-partner/report/getData",
                        "type": "POST",
                        "data" : $data_sent
                    ...
                    render :function(id, type, full, meta){
                        if(type === 'export-excel'){
                            ...
                            if(typeof $json_decode === 'object' && typeof $json_decode.vendor_name !== 'undefined'){
                                return $json_decode.vendor_name;
                            }
                            else
                                return '';
                        }
        ...
        table.buttons( 0, null ).container().addClass('float-right button-wrapper-export').prependTo(
            $('#requestList_filter')
        );
