<form method="POST" id="formApproveModal" enctype="multipart/form-data" data-url-post="{{url('finance/add-business-partner/approval/save-with-form-data')}}" data-loader-file="{{ url('/image/gif/cube.gif') }}">
    ...
    <input type="hidden" name="custom_plant" value="{{ isset($data['data_json']->custom_plant) ? $data['data_json']->custom_plant : '' }}">
    <input type="hidden" name="custom_cost_center" value="{{ isset($data['data_json']->custom_cost_center) ? $data['data_json']->custom_cost_center : '' }}">
    <input type="hidden" name="custom_midjob" value="{{ isset($data['data_json']->custom_midjob) ? $data['data_json']->custom_midjob : '' }}">
    ...
    <div class="form-group">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="request_reason" required placeholder="insert reason for adding new business partner.." value="{{ strtoupper($data['data_json']->request_reason) }}" readonly/>
            </div>
        </div>
        {{-- <div class="row mb-3">
            <div class="col-md-12">
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                ...
                @php $required=($data['divisi']=="accounting")? 'readonly' : 'required'; @endphp
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                @php $required=($data['divisi']=="accounting")? 'required' : 'disabled'; @endphp
                <label>Vendor Type <span class="red">*</span></label>

                @if(isset($data['data_json']->new_type_vendor) && strtoupper($data['data_json']->new_type_vendor) == 'Y')
                    <input type="hidden" name="new_type_vendor" value="Y">
                    <div class="form-check">
                        <label class="form-check-label">
                        <input type="radio" class="form-check-input vendor_type" name="vendor_type" value="Vendor" @if(isset($data['data_json']->vendor_type) && $data['data_json']->vendor_type=="Vendor") checked @endif>Vendor
                        <i class="input-helper"></i></label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                        <input type="radio" class="form-check-input vendor_type" name="vendor_type" value="Customer" @if(isset($data['data_json']->vendor_type) && $data['data_json']->vendor_type=="Customer") checked @endif>Customer
                        <i class="input-helper"></i></label>
                        <div class="customer_type_wrapper ml-4 py-2 mt-2" style="display: none;">
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                <input type="radio" class="form-check-input customer_type" name="customer_type" value="A1" @if(isset($data['data_json']->customer_type) && $data['data_json']->customer_type=="A1") checked @endif>A1 (REV FINAL AYANA)
                                <i class="input-helper"></i></label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                <input type="radio" class="form-check-input customer_type" name="customer_type" value="A2" @if(isset($data['data_json']->customer_type) && $data['data_json']->customer_type=="A2") checked @endif>A2 (REV NON-FINAL AYANA)
                                <i class="input-helper"></i></label>
                            </div>
                        </div>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                        <input type="radio" class="form-check-input vendor_type" name="vendor_type" value="Vendor_Customer" @if(isset($data['data_json']->vendor_type) && $data['data_json']->vendor_type=="Vendor_Customer") checked @endif>Vendor & Customer
                        <i class="input-helper"></i></label>
                    </div>
                @else
                    <div class="form-check">
                        <label class="form-check-label">
                        <input  type="radio" class="form-check-input vendor_type" name="vendor_type" value="PT" @if(isset($data['data_json']->vendor_type) && $data['data_json']->vendor_type=="PT") checked @else {{$required}} @endif >PT
                        <i class="input-helper"></i></label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                        <input type="radio" class="form-check-input vendor_type" name="vendor_type" value="CV" @if(isset($data['data_json']->vendor_type) && $data['data_json']->vendor_type=="CV") checked @else {{$required}}  @endif>CV
                        <i class="input-helper"></i></label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                        <input type="radio" class="form-check-input vendor_type" name="vendor_type" value="Perorangan" @if(isset($data['data_json']->vendor_type) && $data['data_json']->vendor_type=="Perorangan")  @else  {{$required}} @endif>Perorangan
                        <i class="input-helper"></i></label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                        <input type="radio" class="form-check-input vendor_type" name="vendor_type" value="Other" @if(isset($data['data_json']->vendor_type) && $data['data_json']->vendor_type=="Other")  @else {{$required}}  @endif>Other
                        <i class="input-helper"></i></label>
                        <input type="text" name="vendor_type_other" id="vendor_type_other"  class="form-control col-md-3"  @if(isset($data['data_json']->vendor_type) && $data['data_json']->vendor_type!=="Other") style="display:none;" @endif  placeholder="insert other vendor type.." value="{{ isset($data['data_json']->vendor_type_other) ? strtoupper($data['data_json']->vendor_type_other) : '' }}" >
                    </div>
                @endif
            </div>
        </div>
    ...
    <div class="form-group">
        ...
        @php $required=($data['divisi']=="accounting")? 'required' : 'readonly'; @endphp
        <div class="row mb-3">
            <div class="col-md-12">
                <label>Vendor Name <span class="red">*</span></label>
                <input type="text"  class="form-control" name="vendor_name"  placeholder="insert vendor name.."  value="{{ strtoupper($data['data_json']->vendor_name) }}" {{$required}} />
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-12">
                <label>Vendor Address <span class="red">*</span></label>
                <input type="text" class="form-control" name="vendor_address" placeholder="insert vendor full address.."  value="{{ strtoupper($data['data_json']->vendor_address) }}" {{$required}}/>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-6">
                <label>Building <span class="red">*</span></label>
                <input type="text" class="form-control" name="vendor_building"  placeholder="insert vendor building.."  value="{{ strtoupper($data['data_json']->vendor_building) }}" {{$required}}/>
            </div>
            <div class="col-md-6">
                <label>Province<span class="red">*</span></label>
                <input type="text" class="form-control" name="vendor_province"  placeholder="insert vendor province.."  value="{{ strtoupper($data['data_json']->vendor_province) }}"  {{$required}}/>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-6">
                <label>City<span class="red">*</span></label>
                <input type="text" class="form-control" name="vendor_city"  placeholder="insert vendor city"  value="{{ strtoupper($data['data_json']->vendor_city) }}"  {{$required}}/>
            </div>
            <div class="col-md-6">
                <label>District<span class="red">*</span></label>
                <input type="text" class="form-control" name="vendor_district"  placeholder="insert vendor district.."  value="{{ strtoupper($data['data_json']->vendor_district) }}"  {{$required}}/>
            </div>
        </div>
        <div class="row mb-3">
            {{-- <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="vendor_postcode" placeholder="insert postal code.. "  value="{{ strtoupper($data['data_json']->vendor_postcode) }}"  {{$required}}/>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-12">
                <label>Phone Number <span class="red">*</span></label>
                <input type="text"  class="form-control" name="vendor_phone"  placeholder="insert vendor phone.."  value="{{ strtoupper($data['data_json']->vendor_phone) }}"  {{$required}}/>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-12">
                <label>Company Email <span class="red">*</span></label>
                <input type="email"  class="form-control" name="company_email"  placeholder="insert vendor company email.."  value="{{ strtoupper($data['data_json']->company_email) }}"  {{$required}}/>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-12">
                ...
                <div class="col-md-9 float-left">
                    <input type="text"  class="form-control" name="pic_name"  placeholder="insert vendor PIC full name.."  value="{{ strtoupper($data['data_json']->pic_name) }}" {{$required}}/>
                </div>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-12">
                ...
                <input type="text"  class="form-control" name="pic_phone"  placeholder="insert vendor PIC phone.."  value="{{ strtoupper($data['data_json']->pic_phone) }}" {{$required}}/>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-12">
                <label>PIC Email <span class="red">*</span></label>
                <input type="email"  class="form-control" name="pic_email"  placeholder="insert vendor PIC email.."  value="{{ strtoupper($data['data_json']->pic_email) }}" {{$required}}/>
            </div>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                ...
                <div class="form-check">
                    <label class="form-check-label">
                    <input  type="radio" class="form-check-input" name="npwp" value="Yes" @if($data['data_json']->npwp=="Yes") checked @else {{$required}} @endif >Yes
                    <i class="input-helper"></i></label>
                </div>
                <div class="form-check">
                    <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="npwp" value="No" @if($data['data_json']->npwp=="No") checked @else {{$required}} @endif>No
                    <i class="input-helper"></i></label>
                </div>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-12">
                ...
                <div class="form-check">
                    <label class="form-check-label">
                    <input  type="radio" class="form-check-input" name="pkp" value="Yes" @if($data['data_json']->pkp=="Yes") checked @else {{$required}} @endif>Yes
                    <i class="input-helper"></i></label>
                </div>
                <div class="form-check">
                    <label class="form-check-label">
                    <input  type="radio" class="form-check-input" name="pkp" value="No" @if($data['data_json']->pkp=="No") checked @else {{$required}} @endif>No
                    <i class="input-helper"></i></label>
                </div>
            </div>
        </div>
        @if($data['data_json']->npwp=="Yes")
            @php
                $style='style=""';
            @endphp
        @else
            ...
            @endphp
        @endif
         <div class="row mb-3" id="wrap_npwp_number" {{$style}}>
            <div class="col-md-12">
                <label>NPWP Number <span class="red">*</span></label>
                <input type="text"  class="form-control" name="npwp_number"  placeholder="insert vendor NPWP number.."  value="{{$data['data_json']->npwp_number}}"/>
    ...
    <div class="form-group">
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                ...
                <input type="text"  class="form-control" name="bank_name"  placeholder="insert vendor bank name.."  value="{{ strtoupper($data['data_json']->bank_name) }}" {{$required}}/>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-12">
                <label>Bank Account Number <span class="red">*</span></label>
                <input type="text"  class="form-control" name="bank_account_number"  placeholder="insert vendor bank account number.." value="{{ strtoupper($data['data_json']->bank_account_number) }}" {{$required}}/>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-12">
                <label>Swift Code Number</label>
                <input type="text"  class="form-control" name="swift_code"  placeholder="insert vendor bank swift code number.." value="{{ strtoupper($data['data_json']->swift_code) }}" {{$required}}/>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-12">
                <label>Account Holder Name</label>
                <input type="text"  class="form-control" name="account_holder_name"   placeholder="insert vendor account holder name.." value="{{ strtoupper($data['data_json']->account_holder_name) }}" {{$required}}/>
            </div>
        </div>
    </div>
    <div class="form-group">
    ...
    $(document).ready( function () {
        ...
        try {
            $(".vendor_type").each(function(i, elem){
                if(this.checked && this.value == 'Customer'){
