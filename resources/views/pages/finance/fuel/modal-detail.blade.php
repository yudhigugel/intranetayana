<form id="modalDetailAjax">
    ...
    <div class="form-group">
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                ...
                <input type="text" class="form-control" placeholder="" name="bp_number" readonly  value="{{$data['data_json']->bp_number}}"/>
                <small class="form-text text-muted">Filled by Master Data IT</small>
            </div>
        </div>
        <div class="row mb-3">
    ...
    <div class="form-group">
        ...
        <div class="row mb-3" id="wrap_npwp_number">
            <div class="col-md-12">
                <label>NPWP Number <span class="red">*</span></label>
                <input type="text"  class="form-control" name="npwp_number" id="npwp_number" required  placeholder="insert vendor NPWP number.."  value="{{$data['data_json']->npwp_number}}" readonly/>
            </div>
        </div>
    </div>
    <div class="form-group">
