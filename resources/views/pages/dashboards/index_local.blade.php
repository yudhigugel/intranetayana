...
<style>
  ...
  table tbody td.period-forecast.header,
  table thead th.period-forecast.header {
      ...
      <div class="card">
                  ...
                  <div class="d-block">
                      <div class="dropdown d-inline-block" style="margin:0 2.5px;">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownResortButton">
                          ...
                          <a class="dropdown-item text-center filter-resort" href="javascript:void(0)" data-href="WKK1">PNB1</a>
                      ...
                      <div class="d-inline-block" style="margin:0 2.5px;">
                        <form method="GET" action="">
                          <div class="d-inline-block">
                            <div class="mb-1">
                              <small style="color:#000;text-align: left;">Pick Revenue date</small>
                            </div>
                            <input disabled type="text" class="form-control datepicker" name="date" id="datepicker" value="{{ date('Y-m-d', strtotime(isset($data['date_fnb']) ? $data['date_fnb'] : date('Y-m-d') )) }}">
                          </div>
                        </form>
                      </div>
                  </div>
         ...
         <section id="resort">
            ...
            <div class="card-body main-wrapper" style="overflow-x: auto;overflow-y: hidden;">
                ...
                <div class="table-container-h table-responsive">
                    <table class="table table-border" id="content-table">
                        <thead>
                            ...
                            <th class="bg-secondary text-white"	>Room Class</th>
                            <th class="bg-secondary text-white"	>Availability</th>
                            <th class="bg-secondary text-white"	>Occupancy</th>
                            <th class="bg-secondary text-white"	>Occupancy (%)</th>
                            <th class="bg-secondary text-white"	>Revenue (IDR)</th>
                            <th class="bg-secondary text-white"	>MTD Availability</th>
                            <th class="bg-secondary text-white"	>MTD Occupancy</th>
                            <th class="bg-secondary text-white"	>MTD Occupancy (%)</th>
                            <th class="bg-secondary text-white"	>MTD Revenue (IDR)</th>
                            </tr>
                        </thead>
                        <tbody>
                            @if(isset($data['by_room_class']) && $data['by_room_class'])
                              @php
                                $today_avail=$today_occupancy=$today_pct=$today_rev=$mtd_avail=$mtd_occupancy=$mtd_pct=$mtd_rev=0;
                                $count_data_today=$count_data_mtd=0;
                              @endphp
                              @foreach($data['by_room_class'] as $sm_rcl)
                                <tr>
                                  <td class="text-center">{{ $loop->iteration }}</td>
                                  <td class="text-left">{{ $sm_rcl->RoomClass }}</td>
                                  <td class="text-right">{{ number_format($sm_rcl->TodayAvailability ?? 0) }}</td>
                                  <td class="text-right">{{ number_format($sm_rcl->TodayOccupancy ?? 0) }}</td>
                                  <td class="text-right">{{ number_format($sm_rcl->TodayOccupancyPctg ?? 0, 2) }} %</td>
                                  <td class="text-right">{{ number_format($sm_rcl->TodayRevenue ?? 0) }}</td>
                                  <td class="text-right">{{ number_format($sm_rcl->AvailabilityMTD ?? 0) }}</td>
                                  <td class="text-right">{{ number_format($sm_rcl->OccupancyMTD ?? 0) }}</td>
                                  <td class="text-right">{{ number_format($sm_rcl->OccupancyMTDPctg ?? 0) }} %</td>
                                  <td class="text-right">{{ number_format($sm_rcl->RevenueMTD ?? 0) }}</td>
                                </tr>
                                @php
                                  $today_avail += isset($sm_rcl->TodayAvailability) ? (int)$sm_rcl->TodayAvailability : 0;
                                  $today_occupancy += isset($sm_rcl->TodayOccupancy) ? (int)$sm_rcl->TodayOccupancy : 0;
                                  $today_rev += isset($sm_rcl->TodayRevenue) ? (int)$sm_rcl->TodayRevenue : 0;
                                  if(isset($sm_rcl->TodayOccupancyPctg) && (int)$sm_rcl->TodayOccupancyPctg){
                                    $today_pct += (int)$sm_rcl->TodayOccupancyPctg;
                                    $count_data_today++;
                                  }
                                  $mtd_avail += isset($sm_rcl->AvailabilityMTD) ? (int)$sm_rcl->AvailabilityMTD : 0;
                                  $mtd_occupancy += isset($sm_rcl->OccupancyMTD) ? (int)$sm_rcl->OccupancyMTD : 0;
                                  $mtd_rev += isset($sm_rcl->RevenueMTD) ? (int)$sm_rcl->RevenueMTD : 0;
                                  if(isset($sm_rcl->OccupancyMTDPctg) && (int)$sm_rcl->OccupancyMTDPctg){
                                    $mtd_pct += (int)$sm_rcl->OccupancyMTDPctg;
                                    $count_data_mtd++;
                                  }
                                @endphp
                              @endforeach
                              @php
                                if($count_data_today == 0)
                                  $count_data_today = 1;
                                if($count_data_mtd == 0)
                                  $count_data_mtd = 1;
                              @endphp
                              <tr class="totalColumn">
                                ...
                                <td style="text-align: right">{{number_format($today_avail, 0)}}</td>
                                <td style="text-align: right">{{number_format($today_occupancy, 0)}}</td>
                                <td style="text-align: right">{{number_format(($today_pct/$count_data_today), 2)}}%</td>
                                <td style="text-align: right">{{number_format($today_rev, 0)}}</td>
                                <td style="text-align: right">{{number_format($mtd_avail, 0)}}</td>
                                <td style="text-align: right">{{number_format($mtd_occupancy, 0)}}</td>
                                <td style="text-align: right">{{number_format(($mtd_pct/$count_data_mtd), 2)}}%</td>
                                <td style="text-align: right">{{number_format($mtd_rev, 0)}}</td>
                              </tr>
                            @else
                              <tr>
                ...
                <div class="clearfix" style="padding:10px 0px;"></div>
                <h4>By Market</h4>
                <div class="mt-1 mb-3">
                  <h6 class="text-muted">* Posting date : {{ isset($data['date_resort']) ? date('d F, Y', strtotime($data['date_resort'])) : date('d F, Y') }}</h6>
                </div>
                  ...
                  <div class="table-container-h table-responsive">
                      <table class="table table-border" id="content-table">
                          <thead>
                              <tr>
                              <th class="bg-secondary text-white" >No</th>
                              <th class="bg-secondary text-white"	>Market</th>
                              <th class="bg-secondary text-white"	>Number of Rooms</th>
                              <th class="bg-secondary text-white"	>Revenue (IDR)</th>
                              <th class="bg-secondary text-white"	>MTD Number of Rooms</th>
                              <th class="bg-secondary text-white"	>MTD Revenue (IDR)</th>
                              </tr>
                          </thead>
                          <tbody>
                              @if(isset($data['by_market']) && $data['by_market'])
                                @php
                                  $market_occ_today=$market_rev_today=$market_occ_mtd=$market_rev_mtd=0;
                                @endphp
                                @foreach($data['by_market'] as $sm_mc)
                                  <tr>
                                    <td class="text-center">{{ $loop->iteration }}</td>
                                    <td class="text-left">{{ $sm_mc->Market }}</td>
                                    <td class="text-right">{{ number_format($sm_mc->NumberOfRooms ?? 0) }}</td>
                                    <td class="text-right">{{ number_format($sm_mc->TodayRevenue ?? 0) }}</td>
                                    <td class="text-right">{{ number_format($sm_mc->NumberOfRoomsMTD ?? 0) }}</td>
                                    <td class="text-right">{{ number_format($sm_mc->RevenueMTD ?? 0) }}</td>
                                  </tr>
                                  @php
                                    $market_occ_today += isset($sm_mc->NumberOfRooms) ? (int)$sm_mc->NumberOfRooms : 0;
                                    $market_rev_today += isset($sm_mc->TodayRevenue) ? (int)$sm_mc->TodayRevenue : 0;
                                    $market_occ_mtd += isset($sm_mc->NumberOfRoomsMTD) ? (int)$sm_mc->NumberOfRoomsMTD : 0;
                                    $market_rev_mtd += isset($sm_mc->RevenueMTD) ? (int)$sm_mc->RevenueMTD : 0;
                                  @endphp

                                @endforeach
                                <tr class="totalColumn">
                                  <td colspan="2">TOTAL ALL</td>
                                  <td style="text-align: right">{{number_format($market_occ_today, 0)}}</td>
                                  <td style="text-align: right">{{number_format($market_rev_today, 0)}}</td>
                                  <td style="text-align: right">{{number_format($market_occ_mtd, 0)}}</td>
                                  <td style="text-align: right">{{number_format($market_rev_mtd, 0)}}</td>
                                </tr>
                              @else
                                <tr>
                                  <td class="text-center" colspan="10">No Data</td>
                  ...
                  <div class="table-container-h table-responsive">
                      <table class="table table-border" id="content-table">
                          <thead>
                              <tr>
                              <th class="bg-secondary text-white" >No</th>
                              <th class="bg-secondary text-white"	>F&amp;B Outlet</th>
                              <th class="bg-secondary text-white"	>Guest</th>
                              <th class="bg-secondary text-white"	>Revenue (IDR)</th>
                              <th class="bg-secondary text-white"	>MTD Guest</th>
                              <th class="bg-secondary text-white"	>MTD Revenue (IDR)</th>
                              </tr>
                          </thead>
                          <tbody>
                              @if(count($data['report_fnb'])>0)
                                  @php
                                      $total_guest_today=$total_guest_mtd=$total_revenue_today=$total_revenue_mtd=0;
                                  @endphp
                                  @foreach ($data['report_fnb'] as $fb)
                                  <tr>
                                  <td class="text-center">{{ $loop->iteration }}</td>
                                  <td style="text-align: left;">{{$fb->OUTLET_BEAUTY}}</td>
                                  <td style="text-align: right;">{{ number_format($fb->GUEST_TODAY ?? 0) }}</td>
                                  <td style="text-align: right;">{{ number_format($fb->TODAY_REVENUE ?? 0) }}</td>
                                  <td style="text-align: right;">{{ number_format($fb->GUEST_MTD ?? 0) }}</td>
                                  <td style="text-align: right;">{{ number_format($fb->MTD_REVENUE ?? 0) }}</td>
                                  </tr>
                                  @php
                                      $total_guest_today+=$fb->GUEST_TODAY ?? 0;
                                      $total_guest_mtd+=$fb->GUEST_MTD ?? 0;
                                      $total_revenue_today+=$fb->TODAY_REVENUE ?? 0;
                                      $total_revenue_mtd+=$fb->MTD_REVENUE ?? 0;
                                  @endphp
                                  @endforeach
                                  <tr class="totalColumn">
                                      <td colspan="2">TOTAL ALL</td>
                                      <td style="text-align: right">{{number_format($total_guest_today)}}</td>
                                      <td style="text-align: right">{{number_format($total_revenue_today)}}</td>
                                      <td style="text-align: right">{{number_format($total_guest_mtd)}}</td>
                                      <td style="text-align: right">{{number_format($total_revenue_mtd)}}</td>
                                  </tr>
                              @else
            ...
            <div class="card-body main-wrapper" style="overflow-x: auto;overflow-y: hidden;">
                ...
                <div class="table-container-h table-responsive">
                    <table class="table table-border" id="content-table">
                        <thead>
                            <tr>
                            <th class="bg-secondary text-white"	>Spa Outlet</th>
                            <th class="bg-secondary text-white"	>Guest</th>
                            <th class="bg-secondary text-white"	>Revenue (IDR)</th>
                            <th class="bg-secondary text-white"	>MTD Guest</th>
                            <th class="bg-secondary text-white"	>MTD Revenue (IDR)</th>
                        ...
                        <tbody>
                            @if(isset($data['spa_revenue']) && $data['spa_revenue'])
                              @php
                                  $total_spa_guest=0;
                                  $total_spa_revenue=0;
                                  $total_spa_guest_mtd=0;
                                  $total_spa_revenue_mtd=0;
                              @endphp
                              @foreach($data['spa_revenue'] as $spa_rev)
                                <tr>
                                  <td class="text-left">{{ $spa_rev->SpaOutlet }}</td>
                                  <td class="text-right">{{ number_format($spa_rev->SpaTotalGuest) }}</td>
                                  <td class="text-right">{{ number_format($spa_rev->SpaRevenue) }}</td>
                                  <td class="text-right">{{ number_format($spa_rev->SpaTotalGuestMTD) }}</td>
                                  <td class="text-right">{{ number_format($spa_rev->SpaRevenueMTD) }}</td>
                                </tr>
                                @php
                                    $total_spa_guest+=$spa_rev->SpaTotalGuest ?? 0;
                                    $total_spa_revenue+=$spa_rev->SpaRevenue ?? 0;
                                    $total_spa_guest_mtd+=$spa_rev->SpaTotalGuestMTD ?? 0;
                                    $total_spa_revenue_mtd+=$spa_rev->SpaRevenueMTD ?? 0;
                                @endphp
                              @endforeach

                              <tr class="totalColumn">
                                <td >TOTAL ALL</td>
                                <td style="text-align: right">{{number_format($total_spa_guest)}}</td>
                                <td style="text-align: right">{{number_format($total_spa_revenue)}}</td>
                                <td style="text-align: right">{{number_format($total_spa_guest_mtd)}}</td>
                                <td style="text-align: right">{{number_format($total_spa_revenue_mtd)}}</td>
                              </tr>
                            @else
                            <tr>
         ...
         <section id="reservation">
            <div class="divider"></div>
            <div class="card-body main-wrapper" style="overflow-x: auto;overflow-y: hidden;">
                <h2>Reservation Resort Summary</h2>
                <div class="mt-1 mb-3">
                  <h6 class="text-muted">* Posting date : {{ isset($data['date_resort']) ? date('d F, Y', strtotime($data['date_resort'])) : date('d F, Y') }}</h6>
                </div>
                ...
                <div class="table-container-h table-responsive">
                    <table class="table table-border" id="content-table">
                        <thead>
                            <tr>
                            <th class="bg-secondary text-white text-left"></th>
                            <th class="bg-secondary text-white text-left"><b>Room</b> <br>Total Reservation</th>
                            <th class="bg-secondary text-white text-left"><b>Room</b> <br>Total Reservation Revenue</th>
                            </tr>
                        </thead>
                        <tbody>
                          @if(isset($data['reservation_summary']) && $data['reservation_summary'])
                            @foreach($data['reservation_summary'] as $key_rsv => $rsv_sm)
                              <tr>
                                <td class="text-left"><strong>{{ $rsv_sm->Description }}</strong></td>
                                <td class="text-right">{{ number_format($rsv_sm->RoomTotal ?? 0) }}</td>
                                <td class="text-right">{{ number_format($rsv_sm->RoomTotalRevenue ?? 0) }}</td>
                              </tr>
                            @endforeach
                          @else
                          <tr>
                ...
                <div class="table-container-h table-responsive">
                    <table class="table table-border" id="content-table">
                        <thead>
                            <tr>
                            <th class="bg-secondary text-white">Room Class</th>
                            <th class="bg-secondary text-white">Reservation</th>
                            <th class="bg-secondary text-white">Reservation Revenue (IDR)</th>
                            <th class="bg-secondary text-white">MTD Reservation</th>
                            <th class="bg-secondary text-white">MTD Reservation Revenue (IDR)</th>
                            </tr>
                        </thead>
                        <tbody>
                          @if(isset($data['reservation_by_room_class']) && $data['reservation_by_room_class'])
                            @foreach($data['reservation_by_room_class'] as $rsv_by_rcl)
                              <tr>
                                <td class="text-left">{{ $rsv_by_rcl->RoomClassDesc }}</td>
                                <td class="text-right">{{ number_format($rsv_by_rcl->TodayReservation ?? 0) }}</td>
                                <td class="text-right">{{ number_format($rsv_by_rcl->TodayRevenue ?? 0) }}</td>
                                <td class="text-right">{{ number_format($rsv_by_rcl->ReservationMTD ?? 0) }}</td>
                                <td class="text-right">{{ number_format($rsv_by_rcl->RevenueMTD ?? 0) }}</td>
                              </tr>
                            @endforeach
                          @else
                          <tr>
                ...
                <div class="table-wrapper">
                  <div class="table-container-h table-responsive">
                      <table class="table table-border" id="content-table">
                          ...
                          <tbody>
                            @if(isset($data['reservation_by_market']) && $data['reservation_by_market'])
                            @foreach($data['reservation_by_market'] as $rsv_by_mkt)
                              <tr>
                                <td class="text-left">{{ $rsv_by_mkt->MarketDesc }}</td>
                                <td class="text-right">{{ number_format($rsv_by_mkt->TodayReservation ?? 0) }}</td>
                                <td class="text-right">{{ number_format($rsv_by_mkt->TodayRevenue ?? 0) }}</td>
                                <td class="text-right">{{ number_format($rsv_by_mkt->ReservationMTD ?? 0) }}</td>
                                <td class="text-right">{{ number_format($rsv_by_mkt->RevenueMTD ?? 0) }}</td>
                              </tr>
                            @endforeach
                          @else
                          <tr>
                        ...
                        <tbody>
                            @if(isset($data['cancellation_summary']) && $data['cancellation_summary'])
                              @foreach($data['cancellation_summary'] as $cancellation_sm)
                                <tr>
                                  <td class="text-left"><strong>{{ $cancellation_sm->Description }}</strong></td>
                ...
                <div class="table-wrapper">
                  <div class="table-container-h table-responsive">
                      <table class="table table-border" id="content-table">
                          <thead>
                              <tr>
                              <th class="bg-red text-white" >No</th>
                              <th class="bg-red text-white"	>Room Class</th>
                              <th class="bg-red text-white"	>Cancellation</th>
                              <th class="bg-red text-white"	>Loss Revenue (IDR)</th>
                              <th class="bg-red text-white"	>MTD Cancellation</th>
                              <th class="bg-red text-white"	>MTD Loss Revenue (IDR)</th>
                              </tr>
                          </thead>
                          <tbody>
                              @if(isset($data['cancellation_by_room']) && $data['cancellation_by_room'])
                                @php
                                  $clroom_clc_today=$clroom_loss_today=$clroom_clc_mtd=$clroom_loss_mtd=0;
                                @endphp
                                @foreach($data['cancellation_by_room'] as $clc_room)
                                  <tr>
                                    <td class="text-center">{{ $loop->iteration }}</td>
                                    <td class="text-left">{{ $clc_room->RoomClass }}</td>
                                    <td class="text-right">{{ number_format($clc_room->TodayCancellation ?? 0) }}</td>
                                    <td class="text-right">{{ number_format($clc_room->TodayLossRevenue ?? 0) }}</td>
                                    <td class="text-right">{{ number_format($clc_room->CancellationMTD ?? 0) }}</td>
                                    <td class="text-right">{{ number_format($clc_room->LossRevenueMTD ?? 0) }}</td>
                                  </tr>
                                  @php
                                    $clroom_clc_today += isset($clc_room->TodayCancellation) ? (int)$clc_room->TodayCancellation : 0;
                                    $clroom_loss_today += isset($clc_room->TodayLossRevenue) ? (int)$clc_room->TodayLossRevenue : 0;
                                    $clroom_clc_mtd += isset($clc_room->CancellationMTD) ? (int)$clc_room->CancellationMTD : 0;
                                    $clroom_loss_mtd += isset($clc_room->LossRevenueMTD) ? (int)$clc_room->LossRevenueMTD : 0;
                                  @endphp

                                @endforeach
                                <tr class="totalColumn">
                                  <td colspan="2">TOTAL ALL</td>
                                  <td style="text-align: right">{{number_format($clroom_clc_today, 0)}}</td>
                                  <td style="text-align: right">{{number_format($clroom_loss_today, 0)}}</td>
                                  <td style="text-align: right">{{number_format($clroom_clc_mtd, 0)}}</td>
                                  <td style="text-align: right">{{number_format($clroom_loss_mtd, 0)}}</td>
                                </tr>
                              @else
                                <tr>
                                  <td class="text-center" colspan="10">No Data</td>
                  ...
                  <div class="table-container-h table-responsive">
                      <table class="table table-border" id="content-table">
                          <thead>
                              <tr>
                              <th class="bg-red text-white" >No</th>
                              <th class="bg-red text-white"	>Market</th>
                              <th class="bg-red text-white"	>Number of Rooms</th>
                              <th class="bg-red text-white" >Loss Revenue (IDR)</th>
                              <th class="bg-red text-white"	>MTD Number of Rooms</th>
                              <th class="bg-red text-white" >MTD Loss Revenue (IDR)</th>
                              </tr>
                          </thead>
                          <tbody>
                              @if(isset($data['cancellation_by_market']) && $data['cancellation_by_market'])
                                @php
                                  $clmarket_clc_today=$clmarket_loss_today=$clmarket_clc_mtd=$clmarket_loss_mtd=0;
                                @endphp
                                @foreach($data['cancellation_by_market'] as $clc_market)
                                  <tr>
                                    <td class="text-center">{{ $loop->iteration }}</td>
                                    <td class="text-left">{{ $clc_market->Market }}</td>
                                    <td class="text-right">{{ number_format($clc_market->TodayCancellation ?? 0) }}</td>
                                    <td class="text-right">{{ number_format($clc_market->TodayLossRevenue ?? 0) }}</td>
                                    <td class="text-right">{{ number_format($clc_market->CancellationMTD ?? 0) }}</td>
                                    <td class="text-right">{{ number_format($clc_market->LossRevenueMTD ?? 0) }}</td>
                                  </tr>
                                  @php
                                    $clmarket_clc_today += isset($clc_market->TodayCancellation) ? (int)$clc_market->TodayCancellation : 0;
                                    $clmarket_loss_today += isset($clc_market->TodayLossRevenue) ? (int)$clc_market->TodayLossRevenue : 0;
                                    $clmarket_clc_mtd += isset($clc_market->CancellationMTD) ? (int)$clc_market->CancellationMTD : 0;
                                    $clmarket_loss_mtd += isset($clc_market->LossRevenueMTD) ? (int)$clc_market->LossRevenueMTD : 0;
                                  @endphp

                                @endforeach
                                <tr class="totalColumn">
                                  <td colspan="2">TOTAL ALL</td>
                                  <td style="text-align: right">{{number_format($clmarket_clc_today, 0)}}</td>
                                  <td style="text-align: right">{{number_format($clmarket_loss_today, 0)}}</td>
                                  <td style="text-align: right">{{number_format($clmarket_clc_mtd, 0)}}</td>
                                  <td style="text-align: right">{{number_format($clmarket_loss_mtd, 0)}}</td>
                                </tr>
                              @else
                                <tr>
                                  <td class="text-center" colspan="10">No Data</td>
         ...
         <section id="other">
            ...
            <div class="card-body main-wrapper" style="overflow-x: auto;overflow-y: hidden;">
                ...
                <div class="table-container-h table-responsive">
                    <table class="table table-border" id="content-table">
                        <thead>
                            <tr>
                            <th class="bg-secondary text-white text-left"><b>Room</b> <br>Total Availability</th>
                            <th class="bg-secondary text-white text-left"><b>Room</b> <br>Total Occupancy</th>
                            <th class="bg-secondary text-white text-left"><b>Room</b> <br>Total Revenue</th>
                            <th class="bg-secondary text-white text-left"><b>Room</b> <br>Arrival</th>
                            <th class="bg-secondary text-white text-left"><b>Room</b> <br>Departure</th>
                            <th class="bg-red text-white text-left"><b>VIP</b> <br>Arrival</th>
                            <th class="bg-red text-white text-left"><b>VIP</b> <br>Departure</th>
                            <th class="bg-red text-white text-left"><b>VIP</b> <br>In House</th>
                            </tr>
                        </thead>
                        <tbody>
                          @if(isset($data['guestVIP_summary']) && $data['guestVIP_summary'])
                            @foreach($data['guestVIP_summary'] as $vip_sum)
                              <tr>
                                <td class="text-right">{{ number_format($vip_sum->RoomTotalAvailability ?? 0) }}</td>
                                <td class="text-right">{{ number_format($vip_sum->RoomTotalOccupancy ?? 0) }}</td>
                                <td class="text-right ">{{ number_format($vip_sum->RoomTotalRevenue ?? 0) }}</td>
                                <td class="text-right ">{{ number_format($vip_sum->RoomArrival ?? 0) }}</td>
                                <td class="text-right ">{{ number_format($vip_sum->RoomDeparture ?? 0) }}</td>
                                <td class="text-right ">{{ number_format($vip_sum->VIPArrival ?? 0) }}</td>
                                <td class="text-right ">{{ number_format($vip_sum->VIPDeparture ?? 0) }}</td>
                                <td class="text-right ">{{ number_format($vip_sum->VIPInHouse ?? 0) }}</td>
                              </tr>
                            @endforeach
                          @else
                            <tr>
                  ...
                  <div class="table-container-h table-responsive">
                      <table class="table table-border" id="content-table">
                          <thead>
                              ...
                              <th class="bg-secondary text-white text-left"><b>F&amp;B</b> <br>Total Guest</th>
                              <th class="bg-secondary text-white text-left"><b>F&amp;B</b> <br>Total Revenue</th>
                              <th class="bg-secondary text-white text-left"><b>F&amp;B</b> <br>MTD Total Guest</th>
                              <th class="bg-secondary text-white text-left"><b>F&amp;B</b> <br>MTD Total Revenue</th>
                              </tr>
                          </thead>
                          <tbody>
                              @if(isset($data['fnb_daily_operation']) && $data['fnb_daily_operation'])
                                @foreach($data['fnb_daily_operation'] as $fnb_daily)
                                  <tr>
                                    <td class="text-right">{{ number_format($fnb_daily->GUEST_TODAY ?? 0) }}</td>
                                    <td class="text-right">{{ number_format($fnb_daily->TODAY_REVENUE ?? 0) }}</td>
                                    <td class="text-right">{{ number_format($fnb_daily->GUEST_MTD ?? 0) }}</td>
                                    <td class="text-right">{{ number_format($fnb_daily->MTD_REVENUE ?? 0) }}</td>
                                  </tr>
                                @endforeach
                              @else
                                <tr>
                      ...
                      <table class="table table-border" id="content-table">
                          ...
                          <tbody>
                              @if(count($data['report_fnb'])>0)
                                  ...
                                  <tr>
                                  <td style="text-align: left;">{{$fb->OUTLET_BEAUTY}}</td>
                                  <td style="text-align: right;">{{ number_format($fb->GUEST_TODAY) }}</td>
                                  <td style="text-align: right;">{{ number_format($fb->TODAY_REVENUE) }}</td>
                                  <td style="text-align: right;">{{ number_format($fb->GUEST_MTD) }}</td>
                                  <td style="text-align: right;">{{ number_format($fb->MTD_REVENUE) }}</td>
                                  </tr>
                                  @php
                                      $total_guest_today+=$fb->GUEST_TODAY;
                                      $total_guest_mtd+=$fb->GUEST_MTD;
                                      $total_revenue_today+=$fb->TODAY_REVENUE;
                                      $total_revenue_mtd+=$fb->MTD_REVENUE;
                                  @endphp
                                  @endforeach
                                  <tr class="totalColumn">
                                      <td>TOTAL</td>
            ...
            {{--<div class="card-body main-wrapper" style="overflow-x: auto;overflow-y: hidden;">
                ...
                <div class="mt-1 mb-3">
                  <h6 class="text-muted">* On Progress Talenta API</h6>
                </div>
                <div class="table-wrapper">
                <div class="table-container-h table-responsive">
                    <table class="table table-border" id="content-table">
                        <thead>
                            <tr>
                            <th class="bg-secondary text-white text-left"><b>Employee</b> <br>Total</th>
                            <th class="bg-secondary text-white text-left"><b>Daily Worker</b> <br>Total</th>
                            <th class="bg-secondary text-white text-left"><b>Trainee</b> <br>Total</th>
                            <th class="bg-secondary text-white text-left"><b>F&B</b> <br>Total Guest</th>
                            <th class="bg-secondary text-white text-left"><b>F&B</b> <br>Total Revenue</th>
                            <th class="bg-secondary text-white text-left"><b>Spa</b> <br>Total Guest</th>
                            <th class="bg-secondary text-white text-left"><b>Spa</b> <br>Total Revenue</th>
         ...
         {{-- <section id="property">
                ...
                <div class="table-container-h table-responsive">
                    <table class="table table-border" id="content-table">
                        <thead>
                            <tr>
                            <th class="bg-secondary text-white text-left"></th>
                            <th class="bg-secondary text-white text-left"><b>Residence</b> <br>Total Availability</th>
                            <th class="bg-secondary text-white text-left"><b>Residence</b> <br>Total Occupancy</th>
                            <th class="bg-secondary text-white text-left"><b>Residence</b> <br>Total Revenue</th>
                            <th class="bg-secondary text-white text-left"><b>Commercial</b> <br>Total Space Availability</th>
                            <th class="bg-secondary text-white text-left"><b>Commercial</b> <br>Total M2 Availability</th>
                            <th class="bg-secondary text-white text-left"><b>Commercial</b> <br>Total Occupancy</th>
                            <th class="bg-secondary text-white text-left"><b>Commercial</b> <br>Total Revenue</th>
                            <th class="bg-secondary text-white text-left"><b>Residence + Commercial</b> <br>Total Revenue</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
            ...
            <div class="card-body main-wrapper" style="overflow-x: auto;overflow-y: hidden;">
                <h2>Residence Daily Operation</h2>
                <div class="table-wrapper">
                <div class="table-container-h table-responsive">
                    <table class="table table-border" id="content-table">
                        <thead>
                            <tr>
                              ...
                              <th class="bg-secondary text-white text-left"><b>Residence</b> <br>Total Occupancy</th>
                              <th class="bg-secondary text-white text-left"><b>Residence</b> <br>Total Revenue</th>
                              <th class="bg-secondary text-white text-left"><b>Residence</b> <br>Arrival</th>
                              <th class="bg-secondary text-white text-left"><b>Residence</b> <br>Departure</th>
                            </tr>
                        </thead>
                        <tbody>
                          <tr>
            ...
            <div class="card-body main-wrapper" style="overflow-x: auto;overflow-y: hidden;">
                <h2>30 Days Arrival List</h2>
                <div class="table-wrapper">
                <div class="table-container-h table-responsive">
                    <table class="table table-border" id="content-table">
                        <thead>
                            <tr>
                            <th class="bg-secondary text-white text-left"><b>Customer ID</b></th>
                            <th class="bg-secondary text-white text-left"><b>Full Name</b></th>
                            <th class="bg-secondary text-white text-left"><b>Company</b></th>
                            <th class="bg-secondary text-white text-left"><b>Room No</b></th>
                            <th class="bg-secondary text-white text-left"><b>Check In</b></th>
                            <th class="bg-secondary text-white text-left"><b>Check Out</b></th>
                            <th class="bg-secondary text-white text-left"><b>Notes</b></th>
                            <th class="bg-secondary text-white text-left"><b>Preference</b></th>
                            </tr>
                        </thead>
                        <tbody>
                          <tr>
         ...
         {{-- <section id="rental-object">
                ...
                <div class="table-container-h table-responsive">
                    <table class="table table-border" id="content-table">
                        <thead>
                            <tr>
                            <th class="bg-secondary text-white text-left"></th>
                            <th class="bg-secondary text-white text-left"><b>Rental Object</b> <br>Total Availability</th>
                            <th class="bg-secondary text-white text-left"><b>Rental Object</b> <br>Total Unsold Unit</th>
                            <th class="bg-secondary text-white text-left"><b>Rental Object</b> <br>Total Sold Unit - Occupied</th>
                            <th class="bg-secondary text-white text-left"><b>Rental Object</b> <br>Owned Rental - Vacant</th>
                            <th class="bg-secondary text-white text-left"><b>Rental Object</b> <br>Owned Rental - Occupied</th>
                            <th class="bg-secondary text-white text-left"><b>Rental Object</b> <br>Occupancy Rate Rental</th>
                            <th class="bg-secondary text-white text-left"><b>Rental Object</b> <br>Occupancy Rate Total Unit</th>
                            <th class="bg-secondary text-white text-left"><b>Rental Object</b> <br>Total Acoount Balance</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                ...
                <div class="table-container-h table-responsive">
                    <table class="table table-border" id="content-table">
                        <thead>
                          <tr>
                            <th class="bg-secondary text-white" >No</th>
                            <th class="bg-secondary text-white" >SAP Rental <br> Object ID</th>
                            <th class="bg-secondary text-white" >SAP Rental <br> Object Name</th>
                            ...
                            <th class="bg-secondary text-white" style="width: 10%">Account Balance Amount</th>
                            <th class="bg-secondary text-white" style="width: 15%">Pending Maintenance Order</th>
                            <th class="bg-secondary text-white" >Additional Service</th>
                          </tr>
                        </thead>
                        <tbody>
                            <tr>
           ...
           <section id="pnb-revenue">
            ...
            @endif
          <!-- AMBIL HANYA PNB1 REVENUE IKA FILTERNYA PNB1 -->
          @else
          <section id="pnb-revenue">
            <div class="divider"></div>
            <div class="card-body main-wrapper" style="overflow-x: auto;overflow-y: hidden; position: relative;">
