...
@section('content')
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
      ...
      <li aria-current="page" class="breadcrumb-item active"><span>Job-title</span></li></ol>
  </nav>
             ...
             <table id="dynamic-table" class="table table-bordered table-striped" cellspacing="0" width="100%">
               <thead>
                  <tr>
                   ...
                   <th class="all" width="15%">MID JOB TITLE ID</th>
                   <th class="all" width="15%">JOB TITLE</th>
                  </tr>
               </thead>
             </table>
          </div>
      ...
      var table = $('#dynamic-table').DataTable(
         {
            ...
            "ajax": {
              "type" : "GET",
              "url" : "/human-resource/master-data/job-title/getData",
            ...
            "columns": [
               ...
               { "data": "OLD_MIDJOB_ID", className: 'text-left'},
               { "data": "OLD_MIDJOB_TITLE", className: 'text-left'}
            ],
            "buttons": [
               // 'colvis',
               'copyHtml5',
