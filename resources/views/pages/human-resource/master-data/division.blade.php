...
@section('content')
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
      ...
      <li aria-current="page" class="breadcrumb-item active"><span>Division</span></li></ol>
  </nav>
             ...
             <table id="dynamic-table" class="table table-bordered table-striped" cellspacing="0" width="100%">
               <thead>
                  <tr>
                   ...
                   <th class="all" width="15%">DEPARTMENT ID</th>
                   <th class="all" width="15%">DIVISION ID</th>
                   <th class="all" width="60%">DIVISION NAME</th>
                  </tr>
               </thead>
             </table>
          </div>
      ...
      var table = $('#dynamic-table').DataTable(
         {
            ...
            "ajax": {
              "type" : "GET",
              "url" : "/human-resource/master-data/division/getData",
            ...
            "columns": [
               ...
               { "data": "DIVISION_ID", className: 'text-left'},
               { "data": "DIVISION_NAME", className: 'text-left'}
            ],
            "buttons": [
               // 'colvis',
               'copyHtml5',
