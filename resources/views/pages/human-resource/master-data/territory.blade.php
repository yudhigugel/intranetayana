...
@section('content')
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
      ...
      <li aria-current="page" class="breadcrumb-item active"><span>Territory</span></li></ol>
  </nav>
        ...
        <div class="card-body main-wrapper" style="overflow-x: auto;overflow-y: hidden;">
          ...
          <div id="breakpoint">
             <table id="dynamic-table" class="table table-bordered table-striped" cellspacing="0" width="100%">
               <thead>
                  <tr>
                   <th class="all" width="15%">PLANT ID</th>
                   <th class="all" width="15%">TERRITORY CODE</th>
                   <th class="all" width="15%">TERRITORY ID</th>
                   <th class="all" width="50%">TERRITORY NAME</th>
                  </tr>
               </thead>
             </table>
          </div>
      ...
      var table = $('#dynamic-table').DataTable(
         {
            ...
            "ajax": {
              "type" : "GET",
              "data" : { 'business-plant' : '{{ $data['filter'] }}'},
              "url" : "/human-resource/master-data/territory/getData",
            ...
            "serverSide": true,
            "columns": [
               { "data": "PLANT_ID", className: 'text-left'},
               { "data": "ACTION", className: 'text-left'},
               { "data": "TERRITORY_CODE", className: 'text-left'},
