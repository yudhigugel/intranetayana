...
class DailyFlashCostData implements FromView, WithTitle, WithEvents
{	
	use IntranetTrait;
	// Return default data if there's no data
	protected $data_view = 'exports.export';
	protected $data_cost = [];
...
class DailyFlashCost implements WithMultipleSheets
{
	protected $data_cost = [];
    ...
    public function sheets(): array
    {
        ...
        foreach($data_cost_template as $key => $data){
        	...
        	$sheets[] = new DailyFlashCostData(sprintf('exports.%s', $key), $title, $data_pnl);
        }
        return $sheets;
    }
}