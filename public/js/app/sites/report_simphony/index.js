...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/report_simphony/ReportSimphony.vue?vue&type=script&lang=js&":
/*!*****************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/report_simphony/ReportSimphony.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {},
  methods: {
    fetchPOS: function fetchPOS(value) {
      this.isLoading = true;
      var vm = this;
      var baseURI = '/report/fnb_ayana/filter_pos_daily';
      var value_selected = value || vm.selected_date;
  ...
  mounted: function mounted() {
    ...
    $('input[name=date]').datepicker({
      ...
      maxDate: new Date(),
      onSelect: function onSelect(text, obj) {
  ...
  watch: {
    data_pos: function data_pos(val) {
      var vm = this;
          ...
          var $table = $('#content-table').DataTable({
            ...
            buttons: {
              ...
              buttons: [{
                ...
                messageTop: function messageTop() {
                  try {
                    var date = $("#datepicker").datepicker("getDate");
                    date = $.datepicker.formatDate("dd-mm-yy", date);
                    return "Report Date : ".concat(date);
                  } catch (error) {}
                },
                exportOptions: {
            ...
            initComplete: function initComplete() {
              ...
              this.api().columns([3, 4, 1]).every(function (i) {
                ...
                if (i == 1) {
                  var select = $("\n\t\t\t\t                  <div class=\"outlet-wrapper col-12 mt-3\">\n\t\t\t\t                    <div class=\"content-filter-outlet row\">\n\t\t\t\t                      <div class=\"filter-outlet col-7\">\n\t\t\t\t                        <div>\n\t\t\t\t                          <label>Filter By ".concat(text[text_order], "</label>\n\t\t\t\t                          <select class=\"form-control select2 select-multiple filter-select-").concat(i, " mr-3\">\n\t\t\t\t                          </select>\n\t\t\t\t                        </div>\n\t\t\t\t                      </div>\n\t\t\t\t                      <div class=\"export-wrapper col-5\">\n\t\t\t\t                      </div>\n\t\t\t\t                    </div>\n\t\t\t\t                  </div>")).appendTo($('.filter-align')).on('change', function (e) {
                    if ($(e.target).select2('data')) {
                      ...
                      var val = data.join('|'); //search for the option(s) selected
                  ...
                  if (i == 3) {
                    var select = $("<div class=\"content-filter col-2 pt-4\"><input type=\"checkbox\" name=\"fb_yn\" class=\"check-menu\" id=\"fb-yn-checkbox\" value=\"1\"><label>&nbsp;&nbsp;Show only F&B Outlet</label></div>\n\t\t\t\t                    <div class=\"content-filter ".concat(col_length, "\"><label>Filter By ").concat(text[text_order], "</label><div><select class=\"form-control select2 select-standard filter-select-").concat(i, " mr-3\"><option value=\"\">Pilih Data Disini</option></select></div></div>"));
                  } else {
                    var select = $("<div class=\"content-filter ".concat(col_length, "\"><label>Filter By ").concat(text[text_order], "</label><div><select class=\"form-control select2 select-standard filter-select-").concat(i, " mr-3\"><option value=\"\">Pilih Data Disini</option></select></div></div>"));
                  }

                  select.appendTo($('.filter-align')).on('select2:select', function (e) {
                    var value = e.params.data.id; // var val = $.fn.dataTable.util.escapeRegex(
                    //     $(this).val()
                    // );

                    var val = $.fn.dataTable.util.escapeRegex(value); // var column_search = [];
                    // try {
                    ...
                    column.search('').search(val ? '^' + val + '$' : '', true, false).draw();

                    var target_array = _toConsumableArray(e.target.classList);
                    ...
                    if (target_array.includes('filter-select-3')) {
                      ...
                      $.each(unique_search_subresort, function (index, data) {
                        newOption_subresort[index] = new Option("".concat(data), data, false, false);
                      });
                      ...
                      $.each(unique_search_outlet, function (index, data) {
                        newOption_outlet[index] = new Option("".concat(data), data, false, false);
                      });
                    ...
                    if (target_array.includes('filter-select-3')) {
                      ...
                      table_obj.columns([3]).search('') // .search( val ? '^'+val+'$' : '', true, false )
                      .draw();
                      $(this).data('state', 'unselected'); // var unique_search_subresort = [];
                      // var newOption_subresort = [];
                      // $.each(unique_search_subresort, function(index, data){
                      ...
                      var val = $.fn.dataTable.util.escapeRegex("");
                      table_obj.columns([1, 4]).search('') // .search( val ? '^'+val+'$' : '', true, false )
                      .draw();
                ...
                if (i == 3) {
                  column.data().unique().sort().each(function (d, j) {
                    $(".filter-select-".concat(i)).append('<option value="' + d + '">' + d + '</option>');
                  });
                } else {
                  $(".filter-select-".concat(i)).prop('disabled', true);
                }
            ...
            footerCallback: function footerCallback(row, data, start, end, display) {
              ...
              var intVal = function intVal(i) {
                ...
                //     typeof i === 'number' ?
                //         i : 0;
                var data_column = typeof i === 'string' ? i.replace(/(<([^>]+)>)/ig, '').replaceAll(',', '') * 1 : typeof i === 'number' ? i : 0;
                return data_column;
              };
              /* Guest Today */
              ...
              guestTodayAll = api.column(5, {
                search: 'applied'
              }).data().reduce(function (a, b) {
                return intVal(a) + intVal(b);
              }, 0); // Total over this page

              guestTodayPage = api.column(5, {
                page: 'current'
              }).data().reduce(function (a, b) {
                return intVal(a) + intVal(b);
              }, 0);
              ...
              guestMtdAll = api.column(7, {
                search: 'applied'
              }).data().reduce(function (a, b) {
                return intVal(a) + intVal(b);
              }, 0); // Total over this page

              guestMtdPage = api.column(7, {
                page: 'current'
              }).data().reduce(function (a, b) {
                return intVal(a) + intVal(b);
              }, 0);
              ...
              guestYtdAll = api.column(9, {
                search: 'applied'
              }).data().reduce(function (a, b) {
                return intVal(a) + intVal(b);
              }, 0); // Total over this page

              guestYtdPage = api.column(9, {
                page: 'current'
              }).data().reduce(function (a, b) {
                return intVal(a) + intVal(b);
              }, 0);
              ...
              revenueTodayAll = api.column(6, {
                search: 'applied'
              }).data().reduce(function (a, b) {
                return intVal(a) + intVal(b);
              }, 0); // console.log("REVENUE TODAY", revenueTodayAll);
              // Total over this page

              revenueTodayPage = api.column(6, {
                page: 'current'
              }).data().reduce(function (a, b) {
                return intVal(a) + intVal(b);
              }, 0);
              ...
              revenueMtdAll = api.column(8, {
                search: 'applied'
              }).data().reduce(function (a, b) {
                return intVal(a) + intVal(b);
              }, 0); // Total over this page

              revenueMtdPage = api.column(8, {
                page: 'current'
              }).data().reduce(function (a, b) {
                return intVal(a) + intVal(b);
              }, 0);
              ...
              revenueYtdAll = api.column(10, {
                search: 'applied'
              }).data().reduce(function (a, b) {
                return intVal(a) + intVal(b);
              }, 0); // Total over this page

              revenueMtdPage = api.column(10, {
                page: 'current'
              }).data().reduce(function (a, b) {
                return intVal(a) + intVal(b);
              }, 0); // $('.guest-today-page').html(numberWithCommas(guestTodayPage));
              ...
              $('.guest-ytd-all').html(numberWithCommas(guestYtdAll)); // $('.revenue-today-page').html(numberWithCommas(revenueTodayPage));
...
/***/ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/report_simphony/ReportSimphony.vue?vue&type=style&index=0&id=325ee703&scoped=true&lang=css&":
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--9-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--9-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/report_simphony/ReportSimphony.vue?vue&type=style&index=0&id=325ee703&scoped=true&lang=css& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n.vld-overlay.is-active[data-v-325ee703] {\n\talign-items: flex-start !important;\n\tpadding: 2em !important;\n}\n", ""]);
...
/***/ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/report_simphony/ReportSimphony.vue?vue&type=style&index=0&id=325ee703&scoped=true&lang=css&":
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/style-loader!./node_modules/css-loader??ref--9-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--9-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/report_simphony/ReportSimphony.vue?vue&type=style&index=0&id=325ee703&scoped=true&lang=css& ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {


var content = __webpack_require__(/*! !../../../../node_modules/css-loader??ref--9-1!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/src??ref--9-2!../../../../node_modules/vue-loader/lib??vue-loader-options!./ReportSimphony.vue?vue&type=style&index=0&id=325ee703&scoped=true&lang=css& */ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/report_simphony/ReportSimphony.vue?vue&type=style&index=0&id=325ee703&scoped=true&lang=css&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/report_simphony/ReportSimphony.vue?vue&type=template&id=325ee703&scoped=true&":
/*!*********************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/report_simphony/ReportSimphony.vue?vue&type=template&id=325ee703&scoped=true& ***!
  \*********************************************************************************************************************************************************************************************************************************************/
  ...
  return _c(
    ...
    [
        ...
        [
          _c("div", { staticClass: "row" }, [
            _c("div", { staticClass: "col-7" }, [
              _c("h2", [_vm._v(" POS Simphony ")]),
              _vm._v(" "),
              _c("h3", [_vm._v(" Daily Transaction By Revenue Center")]),
              _vm._v(" "),
              _c("h5", [
                _vm._v(" Transaction Date : " + _vm._s(_vm.date_to_show) + " ")
              ])
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "pt-3 col-5" }, [
              _c("form", { attrs: { method: "GET", action: "" } }, [
                _c("div", { staticClass: "form-group col-md-6 float-right" }, [
                  _vm._m(0),
                  _vm._v(" "),
                  _c("input", {
                    directives: [
                    ...
                    on: {
                      input: function($event) {
                        ...
                        _vm.selected_date = $event.target.value
                      }
                    }
                  })
                ])
      ...
      _c(
        "div",
        {
          staticClass: "card-body main-wrapper",
          staticStyle: { "overflow-x": "auto", "overflow-y": "hidden" }
        },
        [_c("div", { domProps: { innerHTML: _vm._s(_vm.data_pos) } })]
      )
    ],
    1
  )
...
/***/ "./resources/js/components/report_simphony/ReportSimphony.vue":
/*!********************************************************************!*\
  !*** ./resources/js/components/report_simphony/ReportSimphony.vue ***!
  \********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ReportSimphony_vue_vue_type_template_id_325ee703_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ReportSimphony.vue?vue&type=template&id=325ee703&scoped=true& */ "./resources/js/components/report_simphony/ReportSimphony.vue?vue&type=template&id=325ee703&scoped=true&");
/* harmony import */ var _ReportSimphony_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ReportSimphony.vue?vue&type=script&lang=js& */ "./resources/js/components/report_simphony/ReportSimphony.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _ReportSimphony_vue_vue_type_style_index_0_id_325ee703_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ReportSimphony.vue?vue&type=style&index=0&id=325ee703&scoped=true&lang=css& */ "./resources/js/components/report_simphony/ReportSimphony.vue?vue&type=style&index=0&id=325ee703&scoped=true&lang=css&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _ReportSimphony_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _ReportSimphony_vue_vue_type_template_id_325ee703_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"],
  _ReportSimphony_vue_vue_type_template_id_325ee703_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  "325ee703",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/report_simphony/ReportSimphony.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components